"""
Training script for the Adult Income dendritic example.

Two commands should reproduce the baseline and dendritic runs:
    python train.py --no-dendrites
    python train.py --use-dendrites --exclude-output-proj
"""
    ...
    with csv_path.open("r", newline="") as handle:
        ...
        for row in reader:
            try:
                ...
                labels.append(row["notes"] or row["model_id"])
