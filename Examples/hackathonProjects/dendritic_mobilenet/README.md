...
| **Validation Accuracy** | *67.4% (Typical)* | **91.42%** |
...
Moving from ~67.4% accuracy (32.6% error) to 91.42% accuracy (8.58% error) represents a significant reduction in error.
Error Reduction: (32.6 - 8.58) / 32.6 ≈ **73.7% reduction in error**.
