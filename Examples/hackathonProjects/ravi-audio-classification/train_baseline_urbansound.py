"""
Train baseline CNN14 model without dendrites on UrbanSound8K.
"""
import os
import json
import argparse
...
def train_baseline_urbansound(args):
    ...
    # Initialize model
    print("\nInitializing CNN14 model for UrbanSound8K (10 classes)...")
    ...
    best_model_path = os.path.join(config.MODELS_DIR, 'baseline_urbansound_best.pt')
    ...
    cm_path = os.path.join(config.MODELS_DIR, 'baseline_urbansound_confusion_matrix.png')
    ...
    results = {
        'model': 'Baseline CNN14 UrbanSound8K',
    ...
    results_path = os.path.join(config.MODELS_DIR, 'baseline_urbansound_results.json')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train baseline CNN on UrbanSound8K')
    ...
    train_baseline_urbansound(args)
