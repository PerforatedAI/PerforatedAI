...
from src.models.unet_baseline_small import get_unet_small
...
NUM_EPOCHS = 20               # 🔴 match dendritic
LR = 3e-5                     # 🔴 match dendritic
PATCH_SIZE = (96, 96, 96)
NUM_CLASSES = 4
DEVICE = "cuda"
...
def main():
    ...
    # ========================
    model = get_unet_small(out_channels=NUM_CLASSES).to(DEVICE)
    ...
    torch.save(
        model.state_dict(),
        "checkpoints/baseline/unet_baseline_compressed.pt"
    )
